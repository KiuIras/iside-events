...
/**
 * A "static" class that implements methods to build valid URLs that fetch events from ISIDe API
 */
public final class QueryBuilder {
    ...
    /**
     * Method to build a URL that fetches last event
     *
     * @return a URL that fetches last event
    ...
    /**
     * Method to build a URL that fetches all events from a start time
     *
     * @param time the time after which the events are to be fetched
     ...
     *
     * @param startTime the time after which the events are to be fetched
     * @param endTime the time before which the events are to be fetched
    ...
    /**
     * Method to build a URL that fetches all events in a specified period of time in a rectangle bounded from two points
     *
     * @param startTime the time after which the events are to be fetched
     * @param endTime the time before which the events are to be fetched
     * @param p1 the point with minimum latitude and longitude
     * @param p2 the point with maximum latitude and longitude
     * @return a URL that fetches events in a specified period of time
     * @throws MalformedURLException
     */
    ...
    /**
     * Method to build a URL that fetches all events from a start time in a rectangle bounded from two points
     *
     * @param time the time after which the events are to be fetched
     * @param p1 the point with minimum latitude and longitude
     * @param p2 the point with maximum latitude and longitude
     ...
     *
     * @param query the "parameters" part
     * @return a valid ISIDe URL
     * @throws MalformedURLException
     */
